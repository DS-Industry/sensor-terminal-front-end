...
export default function instructionPage() {
  return (
    <InstructionLayout>
      <div className=" px-20">
        <h1 className=" font-inter-bold text-5xl my-14">Инструкция</h1>
        <ul className=" flex flex-col gap-11">
          ...
          <li className=" flex flex-row items-start justify-between gap-1">
            ...
            />
            <p className=" font-inter-bold text-2xl text-left ml-5">
              Перед началом основной мойки в программах стандарт и премиум, при
              въезде в бокс, вода подается на днище машины.{" "}
              <p className=" mt-5">
                <span className=" text-primary">Медленно проезжайте </span> над
                зоной распыления воды, чтобы помыть днище машины и диски.
              </p>
            </p>
          </li>
          <li className=" flex flex-row items-start justify-between gap-3">
          ...
          <li className=" flex flex-row items-start justify-between gap-3">
            ...
            <p className=" font-inter-bold text-2xl text-left ml-5">
              ...
              количество циклов вокруг автомобиля, согласно выбранной программе.
            </p>
          </li>
          <li className=" flex flex-row items-start justify-between gap-3">
        ...
        <AttentionTag
          label="Не перемещайте автомобиль во время мойки!"
          additionalStyles=" absolute right-10 bottom-[24rem] text-red-400"
        />
      </div>
      <div className=" px-16 flex flex-row  items-center rounded-[3rem] bg-primary py-5 mt-16">
        ...
        <p className=" text-left font-inter-regular text-2xl ml-10 text-white-500">
          Для того чтобы начать следующий цикл мойки,
          <p>необходимо в обязательном порядке выехать из поста!</p>
        </p>
      </div>
    </InstructionLayout>
  );
