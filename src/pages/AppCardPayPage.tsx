  ...
  return (
    <VideoLayout programUrl={state.promoUrl}>
      {payType === "" && (
        <div className=" flex flex-col items-center">
          ...
          <p className=" font-montserrat-regular mt-10 text-[1rem]">
            {t(
              "Для оплаты одним из способов необходимо будет приложить карту лояльности"
            )}
          </p>
          <div className=" flex flex-row mt-10 gap-10 min-h-[500px]">
            <div className=" flex flex-col justify-between bg-primary p-7 text-white-500 max-w-[300px] min-w-[300px] rounded-[40px] ">
              ...
              <div>
                ...
                <p className=" font-inter-semibold text-left text-[20px] mb-14">
                  {t("Оплатите мойку баллами с карты")}
                </p>
                <button
                  onClick={handleClick}
                  value="points"
            ...
            <div className=" flex flex-col justify-between bg-primary p-7 text-white-500 max-w-[300px] min-w-[300px] rounded-[40px]">
              <div className=" flex flex-row justify-between">
                <div>
                  <p className=" text-left">{t("Ваш СashBack")}</p>
              ...
              <div>
                ...
                <p className=" font-inter-semibold text-left text-[20px] mb-7">
                  {t("Вы получите CashBack от внесенной вами суммы")}
                </p>
                <button
                  onClick={handleClick}
                  value="cashback"
      ...
      {payType === "points" && !isCardRead && (
        <div className=" flex flex-row justify-between mt-10 px-[5rem] gap-10">
          <div>
            <p className=" text-left font-inter-bold text-[3.5rem]">
              {t("Для списания баллов приложите карту повторно")}
            </p>
            <img
              src={WifiPromoCard}
              alt="wifi paycard"
              className="absolute size-[400px] mt-[4rem]"
            />
          </div>
          <div className=" bg-primary min-w-[350px] min-h-[730px] mt-4 rounded-3xl flex flex-col justify-between shadow-[0px_20px_40px_15px_rgba(0,0,0,0.3)]">
            ...
            <div className=" absolute bottom-[44.2rem] right-[4rem]">
              <AttentionTag
                label={t("Приложите карту для списания баллов!")}
      ...
      {payType === "cashback" && !isCardRead && (
        <div className=" flex flex-row justify-between px-[5rem] gap-[10rem]">
          <div>
            ...
            />
            <p className=" text-left font-inter-bold text-[2rem] pl-2">
              <Trans i18nKey={"Или внесите купюры в купюроприемник"}>
          ...
          <div className=" bg-primary min-w-[350px] min-h-[700px] rounded-3xl flex flex-col justify-between shadow-[0px_20px_40px_15px_rgba(0,0,0,0.3)] mt-5">
            ...
            <div className=" absolute bottom-[20rem] right-[4rem]">
              <AttentionTag
                label={t("Терминал сдачу не выдает!")}
                additionalStyles={` ${
                  i18n.language !== "ru" ? "max-w-[230px]" : "max-w-[210px]"
                } text-red-400`}
              />
            </div>
            <div>
